    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[85vw] desktop:max-w-6xl max-h-[95vh] overflow-y-auto mobile:max-w-[calc(100vw-1rem)] mobile:max-h-[95vh] mobile:m-2">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="mb-3 text-sm font-medium text-muted-foreground">Estimated Ad Spend</h3>
          ...
          {topBrands.length > 0 && (
            <div>
              <h3 className="mb-3 text-sm font-medium text-muted-foreground">Top Brands</h3>
              <div className="flex flex-wrap gap-2">
                {topBrands.map((brand) => (
