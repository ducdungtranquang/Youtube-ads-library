...
export default function CompanyVideosPage({
  ...
  if (typeof (params as any).then === "function") {
    // @ts-ignore
    companyId = require("react").use(params).companyId;
  } else {
    // @ts-ignore
    companyId = (params as any).companyId;
  }
  ...
  useEffect(() => {
    async function fetchVideos() {
      ...
      try {
        const apiPath =
          filter === "shorts"
            ? `/api/companies/${companyId}/shorts?page=${page}&limit=${limit}`
            : `/api/companies/${companyId}/videos?page=${page}&limit=${limit}`;
